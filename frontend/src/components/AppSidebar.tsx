			...
			<TooltipProvider delayDuration={0}>
				<div className="flex h-full flex-col items-center w-full">
					...
					<SidebarFooter className="p-2 w-full mt-auto">
						...
						{/* AGPL v3 attribution + source-code link.
						    Required by Section 13 of the AGPL: the source for this
						    network-accessible service must be offered to users. The
						    full fork is public on GitHub, so we link to it. */}
						<div className="mt-2 pt-2 border-t border-border/40 flex flex-col items-center gap-1 text-[10px] text-muted-foreground/70">
							<a
								href="https://github.com/DiverseInc/DepthSight"
								target="_blank"
								rel="noopener noreferrer"
								className="hover:text-foreground transition-colors inline-flex items-center gap-1"
								title="View source code (AGPL v3)"
							>
								<svg
